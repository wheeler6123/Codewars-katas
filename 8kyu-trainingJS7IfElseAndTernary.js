...
//P: input param will be one, an integer representing the number of hot dogs being purchased
//R: the price decreases as the volume goes up, return the total cost for the number of hot dogs input
//E: 1 => 100
  // 4 => 400
  // 9 => 855
  // 10 => 900
//P: use a ternary to take in the number of hotdogs and return the correct price multiplied by number of hot dogs
