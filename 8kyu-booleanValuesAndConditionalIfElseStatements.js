...
//P: input is a half-completed function that takes in a val
//R: function should return string 'true' if the input val evaluates to true and 'false' accordingly
//E: true => 'true'
  // false => 'false'
//P: use a ternary to return corresponding strings for the boolean value of val
