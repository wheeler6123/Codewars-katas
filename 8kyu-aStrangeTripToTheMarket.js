...
//P: one input, a string representing a message from a performer you are talking to
//R: return a boolean value for if the performer is the loch ness monster
//E: 'Your girlscout cookies are ready to ship. Your total comes to tree fiddy' => true
//P: check to see if the string contains 'tree fiddy', '3.50', or 'three fifty', if yes 'true' if not 'false'
